...
const envSchema = z.object({
  ...
  RNS_REGISTRY_ADDRESS: z.string().regex(/^0x[a-fA-F0-9]{40}$/).default("0xa8d639540D11bd295d12a8F56DA5D2F53aBC0caF"),
  RNS_RESOLVER_ADDRESS: z.string().regex(/^0x[a-fA-F0-9]{40}$/).default("0x251c89457FbFF8930ae1D400C67E33B76498502b"),
  RNS_REGISTRAR_ADDRESS: z.string().regex(/^0x[a-fA-F0-9]{40}$/).default("0x26F762137df7821369E95263f3EB556d96C4cEbB"),
  ...
  RNS_REGISTRY_START_BLOCK: z.coerce.bigint().nonnegative().optional(),
  RNS_RESOLVER_START_BLOCK: z.coerce.bigint().nonnegative().optional(),
  RNS_REGISTRAR_START_BLOCK: z.coerce.bigint().nonnegative().optional(),
