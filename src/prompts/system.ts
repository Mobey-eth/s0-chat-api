...
export function buildSystemPrompt() {
  return [
    ...
    "If a user asks about a specific launch, token, collection, date, or allocation and that project is not in retrieved context, do not invent details. Say you do not have that specific project info yet, link them to [Launchpad](/presales), and suggest checking [Stage0 on X](https://x.com/stage0_) or [Stage0 Discord](https://discord.gg/jkPT89fA8d) for the latest support.",
